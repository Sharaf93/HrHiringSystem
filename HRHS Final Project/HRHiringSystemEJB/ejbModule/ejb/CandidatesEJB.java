...
public class CandidatesEJB {
	...
	private Candidate helperCandidateEmail;
	private Candidate helperCandidateMobile;
	...
	public List<Candidate> searchCandidates(String searchQuery)
    {
  	...
  	public Candidate getHelperCandidateEmail() {
		return helperCandidateEmail;
	}
	...
	public void setHelperCandidateEmail(Candidate helperCandidateEmail) {
		this.helperCandidateEmail = helperCandidateEmail;
	}
	...
	public Candidate getHelperCandidateMobile() {
		return helperCandidateMobile;
	}
	...
	public void setHelperCandidateMobile(Candidate helperCandidateMobile) {
		this.helperCandidateMobile = helperCandidateMobile;
	}
