...
/*	public static String trimFilePath(String fileName) {
	...
	//	System.out.println(x.toString());
	   ...
	   //hr source IDS
		...
		initialPhase.setLastmodifiedbyid(assignedHRSourceId);
		...
		FacesContext.getCurrentInstance().getExternalContext().redirect("viewcandidate.faces?candidateId=" + candidateID);
		return null;
	}
