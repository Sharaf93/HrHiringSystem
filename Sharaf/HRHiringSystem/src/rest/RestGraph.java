...
//	public List<Integer> getUpdatedROFs(){
		
//		return candidatesEJB.getUpdatedROFs();
//	}
	...
	public Response generate(@PathParam("hrId") String hrId, @PathParam("startDate") String startDate, @PathParam("endDate") String endDate) throws ParseException {
		...
		array.add(getJsonFailAnalysis(chosenEmployeeID,start,end));
		array.add(getJsonPendingAnalysis(chosenEmployeeID,start,end));
		array.add(getJsonPassAnalysis(chosenEmployeeID,start,end));
		array.add(getJsonSourcesPass(chosenEmployeeID,start,end));
...
//		 getJsonPendingAnalysis(hrID,startDate,endDate);
